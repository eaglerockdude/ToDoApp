...
Todo.create!(title: 'cat groomers', notes: 'Take Lilo to the groomers on Wednesday the 3rd')
Todo.create!(title: 'website do', notes: 'Complete sample website by end of next week.')